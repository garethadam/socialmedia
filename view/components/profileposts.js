class Posts extends React.Component {
 ...
 constructor(props) {
    super(props)
    this.state = { posts:posts, comments:comments, images:images, comment:"Enter your comment", post:"", likes:likes}
	 }
	...
	comment(req)
	  {
	  	...
	  	return <form action="http://localhost/socialmedia/controller/profilecomment.php"  method="post" className="createComment"  enctype='multipart/form-data'>
		  ...
		  item=<div className="postDesign" key={i}>
                    <div className="posterInformation" >
                        ...
                        <div className="postDetails">
                            <p><a href={"profile.php?user=" + posts.uid[i]}> {posts.name[i]} {posts.lastname[i]} </a></p>
